...
function TextArea({ label, error, ...props }: ITextAreaProps, ref: React.ForwardedRef<HTMLTextAreaElement>) {
    return (
        <div className="form-control">
            ...
            >
                <textarea
                    className={`textarea  textarea-bordered h-24 ${error ? "input-error" : ""}`}
