...
export default function Pagination({ totalItems, currentPage, pageSize, onChange }: Props) {
    ...
    return (
        <nav
            className="flex mt-4 justify-between items-end border-t border-neutral-200"
            role="navigation"
